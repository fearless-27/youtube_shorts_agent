/**
 * GhostPipe Streamline Icon Set
 * Streamline-inspired SVG icons — inline, zero dependency, customizable
 * Source inspiration: streamlinehq.com (manual SVG implementation)
...
const icon = (paths: React.ReactNode, w = 24, h = 24) =>
  ({ size = defaults.size, color, className, strokeWidth = defaults.strokeWidth, style }: IconProps) =>
    (
      <svg
        width={size}
        height={size}
...
export const IconSparkles = icon(
  <>
    ...
    <path d="M5 17L5.46 19.15L7.5 20L5.46 20.85L5 23L4.54 20.85L2.5 20L4.54 19.15L5 17Z" />
    <path d="M19 3L19.46 5.15L21.5 6L19.46 6.85L19 9L18.54 6.85L16.5 6L18.54 5.15L19 3Z" />
  </>
);
...
export const IconPipe = icon(
  <>
    <path d="M2 12h8M14 12h8" />
    <circle cx="12" cy="12" r="2" />
    <path d="M6 6v3M6 15v3M18 6v3M18 15v3" />
    <rect x="4" y="4" width="4" height="16" rx="1" opacity="0.4" />
    <rect x="16" y="4" width="4" height="16" rx="1" opacity="0.4" />
  </>
);

export const IconSlidersH = icon(
  <>
